  ...
  techStack: {
    languages: [
      ...
      },
      {
        id: "lang-5",
        name: "C#",
        description: "Enterprise-grade applications with .NET ecosystem",
        icon: "csharp",
        useCase: "Desktop & web applications",
        yearsOfExp: 2,
      },
    ],
    frameworks: [
      ...
      },
      {
        ...
        icon: "dotnet",
        performance: "Compiled code execution",
      ...
      },
      {
        ...
        icon: "nextjs",
        performance: "SSR and SSG optimization",
  ...
  projects: [
    {
      ...
      githubUrl: "https://github.com/YuuNakata/Portfolio-Astro",
      imageUrl: undefined,
      featured: true,
    },
    {
    ...
    {
      id: "project-5",
      titleKey: "project.moogle.title",
      descriptionKey: "project.moogle.description",
      technologies: [
        "C#",
        ".NET",
        "ASP.NET Core",
      ...
      liveUrl: undefined,
      githubUrl: "https://github.com/YuuNakata/moogle-clone",
      imageUrl: undefined,
      featured: true,
    },
    {
      id: "project-6",
      titleKey: "project.moetasker.title",
      descriptionKey: "project.moetasker.description",
      technologies: [
        "Next.js",
        "JavaScript",
        "Telegram Bot API",
      ...
      liveUrl: "https://t.me/Moe_TaskerBot",
      githubUrl: "https://github.com/YuuNakata/MoeTasker",
      imageUrl: undefined,
      featured: true,
    },
  ],
